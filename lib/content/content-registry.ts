...
const registry: Record<ContentPageKey, ContentRegistryItem> = {
  ...
  services: {
    ...
    sections: [
      ...
      { id: "categories", label: "Quick Categories", description: "Category navigation", icon: "LayoutGrid" },
      ...
      { id: "pricing", label: "Pricing Matrix", description: "Service pricing overview", icon: "DollarSign" },
      { id: "process", label: "Appointment Process", description: "Booking process steps", icon: "ListChecks" },
      { id: "gallery", label: "Design Inspiration", description: "Gallery showcase", icon: "Palette" },
      { id: "packages", label: "Featured Packages", description: "Package highlights", icon: "Package" },
      { id: "faqs", label: "FAQ", description: "Frequently asked questions", icon: "HelpCircle" },
      { id: "cta", label: "Final CTA", description: "Bottom call-to-action", icon: "MousePointerClick" },
    ],
  },
  ...
  gallery: {
    ...
    sections: [
      ...
      { id: "categories", label: "Filter Labels", description: "Category filter labels", icon: "Filter" },
      { id: "collections", label: "Featured Collections", description: "Highlighted collections", icon: "FolderHeart" },
      { id: "whyChoose", label: "Why Choose Us", description: "Benefits and differentiators", icon: "Award" },
      { id: "trends", label: "Trending Inspiration", description: "Trending design styles", icon: "TrendingUp" },
      { id: "processSteps", label: "Process", description: "Our process steps", icon: "ListChecks" },
      { id: "testimonials", label: "Testimonials", description: "Client testimonials", icon: "Quote" },
      { id: "cta", label: "Final CTA", description: "Bottom call-to-action", icon: "MousePointerClick" },
    ],
  },
  ...
  promotions: {
    ...
    sections: [
      ...
      { id: "faq", label: "FAQ", description: "Frequently asked questions", icon: "HelpCircle" },
      { id: "finalCta", label: "Final CTA", description: "Bottom call-to-action", icon: "MousePointerClick" },
    ],
  },
  ...
  blog: {
    ...
    sections: [
      ...
      { id: "latestPosts", label: "Latest Stories", description: "Latest posts section config", icon: "Newspaper" },
      { id: "popularCategories", label: "Category Navigation", description: "Category navigation settings", icon: "LayoutGrid" },
      { id: "editorsPicks", label: "Editor's Picks", description: "Curated post selections", icon: "Star" },
      { id: "trendingPosts", label: "Trending Stories", description: "Trending posts section", icon: "TrendingUp" },
