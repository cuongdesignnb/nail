    ...
    <AdminSectionCard title="Header Mobile Navigation">
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          <label className={`rounded-xl border p-4 ${settings.headerMobileMode === "inherit_header_primary" ? "border-aera-accent bg-aera-champagne/20" : "border-aera-champagne/40"}`}>
            <input
              type="radio"
            ...
            />
            <span className="ml-2 text-sm font-bold text-aera-ink">Use Primary Header Menu</span>
          </label>
          <label className={`rounded-xl border p-4 ${settings.headerMobileMode === "custom_menu" ? "border-aera-accent bg-aera-champagne/20" : "border-aera-champagne/40"}`}>
            <input
              type="radio"
              name="headerMobileMode"
            ...
            />
            <span className="ml-2 text-sm font-bold text-aera-ink">Use Custom Mobile Menu</span>
          </label>
        </div>
        {settings.headerMobileMode === "custom_menu" && (
          <div>
            <label className="text-xs font-bold uppercase tracking-wider text-aera-muted">Custom Mobile Menu Assignment</label>
            <select
