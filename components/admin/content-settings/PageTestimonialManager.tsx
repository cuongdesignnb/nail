      ...
      <div className="lg:col-span-7 bg-white rounded-3xl p-6 border border-aera-champagne/45 shadow-luxury">
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {list.map((test) => (
              <div key={test.id} className="p-4 border border-aera-champagne/30 rounded-2xl flex justify-between items-start gap-4">
                <div className="space-y-1">
                  ...
                  <p className="text-xs italic text-aera-muted">&quot;{test.quote}&quot;</p>
                  <h4 className="font-semibold text-xs text-aera-ink pt-1">
            ...
            {list.length === 0 && (
              <p className="text-xs text-aera-muted italic py-6 text-center">No reviews found for this page.</p>
            )}
          </div>
        )}
      </div>
