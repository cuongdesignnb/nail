...
export function ContentCompletionList({ missing }: { missing: string[] }) {
  ...
  return (
    <div className="mt-3 pt-3 border-t border-aera-champagne/40">
      <p className="text-[10px] font-bold uppercase tracking-wider text-aera-muted mb-2">
      ...
      <AnimatePresence>
        {needsCollapse && !expanded && (
          <motion.button
            ...
            className="flex items-center gap-1 mt-1.5 text-[11px] font-medium text-aera-accent hover:text-aera-accentHover transition-colors"
          >
