...
export default function GiftCardSuccessPage({ searchParams }: { searchParams: { order?: string } }) {
  return (
    <main className="bg-[#fbf4e8] px-4 py-20 text-[#3d2d24]">
      <section className="mx-auto max-w-2xl rounded-[28px] border border-[#ead9bd] bg-white p-8 text-center shadow-sm">
        ...
        <p className="mt-4 text-[#725744]">Your PayPal payment was verified and your Aera Nail Lounge Gift Card has been issued.</p>
