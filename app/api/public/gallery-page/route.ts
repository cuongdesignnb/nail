...
export async function GET() {
  try {
    ...
    const pageContent: GalleryPageContent = {
      seo: {
      ...
      whyChoose: {
        ...
        features: defaultGalleryContent.whyChoose.features, // standard features
      },
    ...
    console.error("GET Public Gallery Page Error:", error);
    return NextResponse.json({
      success: true,
      data: defaultGalleryContent, // fallback on error
    });
  }
}
